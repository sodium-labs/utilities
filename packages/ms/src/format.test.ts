...
describe("format(number, { long: true })", () => {
    ...
    it("should support days", () => {
        ...
        expect(format(-1 * 6 * 24 * 60 * 60 * 1000, { long: true })).toBe("-6 days");
    });
    ...
    it("should support weeks", () => {
        ...
        expect(format(-1 * 1 * 7 * 24 * 60 * 60 * 1000, { long: true })).toBe("-1 week");
        expect(format(-1 * 2 * 7 * 24 * 60 * 60 * 1000, { long: true })).toBe("-2 weeks");
    });
    ...
    it("should support months", () => {
        ...
        expect(format(-1 * 30.4375 * 24 * 60 * 60 * 1000, { long: true })).toBe("-1 month");
        expect(format(-1 * 30.4375 * 24 * 60 * 60 * 1200, { long: true })).toBe("-1 month");
        expect(format(-1 * 30.4375 * 24 * 60 * 60 * 10000, { long: true })).toBe("-10 months");
    });
    ...
    it("should support years", () => {
        ...
        expect(format(-1 * 365.25 * 24 * 60 * 60 * 1000 - 1, { long: true })).toBe("-1 year");
        expect(format(-1 * 365.25 * 24 * 60 * 60 * 1200 - 1, { long: true })).toBe("-1 year");
        expect(format(-1 * 365.25 * 24 * 60 * 60 * 10000 - 1, { long: true })).toBe("-10 years");
    });
...
describe("format(string, { compound: true })", () => {
    it("should support compound", () => {
        expect(format(65002)).toBe("1m");
        expect(format(65002, { compound: true })).toBe("1m5s2ms");
        expect(format(65002, { compound: true, maxUnits: 2 })).toBe("1m5s");
        expect(format(65002, { long: true, compound: true })).toBe("1 minute 5 seconds 2 milliseconds");
    });
});
