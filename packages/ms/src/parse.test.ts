...
describe("parse(string)", () => {
    ...
    it("should fail on invalid caracters", () => {
        expect(Number.isNaN(parse("10----5"))).toBe(true);
        expect(Number.isNaN(parse("10min hello 5s"))).toBe(true);
        expect(Number.isNaN(parse("2s world"))).toBe(true);
    });

    it("should be case-insensitive", () => {
        expect(parse("1.5H")).toBe(5400000);
        expect(parse("53 YeArS")).toBe(1671408000000);
...
describe("parse(long string)", () => {
    ...
    it("should convert months to ms", () => {
        expect(parse("1 month")).toBe(2592000000);
    });
